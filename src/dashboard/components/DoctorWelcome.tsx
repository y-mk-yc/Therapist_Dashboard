...
export const DoctorWelcome = () =>
{
    ...
    return <div className='card bg-secondary2 flex mb-5 items-stretch justify-between p-0  flex-wrap'>
...
const AtClicDoctorWelcomeInner = () =>
{
    ...
    return <>
        ...
        <div className={'flex gap-4'}>
            ...
            <button className={'btn-secondary mt-4 h-15 p-0 self-center mb-4'} onClick={onLogout}>Log out <AiOutlineLogout /></button>
